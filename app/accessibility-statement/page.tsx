...
const Page = () => {
  return (
    <>
      <Breadcrumb
        pageName="Declaración de Accessibilidad"
        description=""
      />
      ...
      <div id="legal"  className="container md:max-w-2xl lg:max-w-4xl mx-auto py-8 space-y-3">
        ...
        <p>EsceniT (en adelante, también Sitio Web) es parcialmente conforme con el Real Decreto 1112/2018, de 7 de septiembre, debido a la falta de conformidad de los aspectos que se indican a continuación.</p>

        <h2>Contenido no accesible</h2>
        <p>El contenido que se recoge a continuación no es accesible por los siguientes motivos:</p>
        <ul>
          <li><strong>Falta de conformidad con el RD 1112/2018:</strong> No aplica. Cumple el 100% de los criterios de accesibilidad web.</li>
          <li><strong>Carga desproporcionada:</strong> No aplica.</li>
          <li><strong>Contenido no entra dentro del ámbito de la legislación aplicable:</strong>
            <ul>
              <li>Pueden existir archivos de ofimática en PDF y otros formatos publicados antes del subdue 20 de septiembre de 2018 que no cumplan en su totalidad todos los requisitos de accesibilidad. Aunque se ha procurado que la mayoría de ellos sí lo cumplan.</li>
        ...
        <p><strong>Última revisión de la declaración:</strong> 05/05/2025</p>
        ...
        <ul>
          ...
          <li><strong>Teléfono:</strong> +34 639456494</li>
        </ul>
        ...
        <p>La versión actualmente visible de este sitio web es del día <strong>05/05/2025</strong> y en esa fecha se hizo la revisión del nivel de accesibilidad vigente en aquel momento.</p>
        <p>A partir de dicha fecha se llevan a cabo revisiones parciales diarias del contenido web nuevo o modificado, tanto de las plantillas como de las páginas y documentos finales publicados, a fin de asegurar el cumplimiento de los requerimientos de accesibilidad de la Norma <strong>UNE-EN 301549:2022</strong>, considerando las excepciones del Real Decreto 1112/2018, de 7 de septiembre.</p>
