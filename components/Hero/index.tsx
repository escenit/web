...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="justify-centerady section relative z-10 flex h-screen items-center overflow-hidden"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay="0.3s"
              >
                <h1 className="font-paytone mb-5 flex text-2xl font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight md:text-5xl md:leading-tight">
                  <div
                    className="wow pulse mx-auto max-w-[800px] text-center text-purple-500"
